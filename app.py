...
async def filter_audio(client, message):
    ...
    #    reply_w_timestamp += "\n\n"
    for i in range(len(response["results"]["channels"][0]["alternatives"][0]["paragraphs"]["paragraphs"])):
        reply_w_timestamp += str(response["results"]["channels"][0]["alternatives"][0]["paragraphs"]["paragraphs"][1]["sentences"][i]["start"]) + " to "
        reply_w_timestamp += str(response["results"]["channels"][0]["alternatives"][0]["paragraphs"]["paragraphs"][1]["sentences"][i]["end"]) + "\n" 
        reply_w_timestamp += response["results"]["channels"][0]["alternatives"][0]["paragraphs"]["paragraphs"][1]["sentences"][i]["text"]
        reply_w_timestamp += "\n\n"
